...
public class ResourceManager {
    ...
    public Label.LabelStyle equationLabelStyle;
    ...
    public void dispose(){
        assetManager.dispose(); // Dispose AssetManager to unload all managed assets
        skin.dispose(); // Dispose Skin
        atlas.dispose(); // Dispose TextureAtlas

        // Dispose Textures
        titleScreenBackground.dispose();
