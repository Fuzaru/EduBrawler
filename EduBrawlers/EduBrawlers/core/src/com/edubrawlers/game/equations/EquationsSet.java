...
public class EquationsSet {
    ...
    static {
        ...
        EQUATIONS_LIST.add(new Equations("9 x (5 - 3^2) + 2^2 =", new String[] {"53", "90", "-32", "-53"}, 2));
        EQUATIONS_LIST.add(new Equations("4 * (2^3 + 1) - 3^2 =", new String[] {"45", "27", "32", "68"}, 1));
        EQUATIONS_LIST.add(new Equations("6 * (7 - 2^2) + 3 =", new String[] {"51", "42", "28", "21"}, 3));
        EQUATIONS_LIST.add(new Equations("3^3 x (3 + 2^2) - 5 =", new String[] {"238", "167", "240", "231"}, 0));
        EQUATIONS_LIST.add(new Equations("9 x (3^2 - 2) - 2^3 =", new String[] {"127", "55", "42", "75"}, 1));

        EQUATIONS_LIST.add(new Equations("Derive y = 5x^0: ", new String[] {"y' = 0", "y' = 1", "y' = -1", "y' = 2"}, 0));
        EQUATIONS_LIST.add(new Equations("Derive y = 3 cos x: ", new String[] {"y' = - sin (3x)", "y' = - 3 sin (x)", "y' = 3 sin (3x)", "y' = 3 sin (x)"}, 1));
        EQUATIONS_LIST.add(new Equations("Derive y = x^20 / 4: ", new String[] {"y' = 20x^4 / 19", "y' = 5x", "y' = 20x^19", "y' = 5x^19"}, 3));
        EQUATIONS_LIST.add(new Equations("(x-2)(x+1); Evaluate: ", new String[] {"x^2 - x - 2", "x^2 - 3x - 2", "x^2 + x + 2", "x^2 - x - 1"}, 0));
        EQUATIONS_LIST.add(new Equations("f(x)=5x^2+2x+9; evaluate f(4)", new String[] {"104", "62", "97", "84"}, 2));
